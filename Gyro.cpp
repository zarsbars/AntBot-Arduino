...
void Gyro::setup()
{
	...
	attachInterrupt(digitalPinToInterrupt(3), dmpDataReady, RISING); //Changed interrupt pin to 3
...
float Gyro::read()
{
	...
	return ypr[0] * 180 / M_PI - homeAngle;
}
...
//MPU6050_6Axis_MotionApps20 header file
